...
import numpy as np
import string
from tokenise_data import tokenise_json_data
from logger_info import setup_logger
import json
...
def data_stats(PROJECT_FOLDER, LOGGER):
    ...
    # Get histogram of sentence length
    # Get histogram of NER label counts
    ...
    print(df.head())
    print(min_len, max_len, avg_len, std_len, len_95_perc)
